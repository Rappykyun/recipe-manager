...
<div class="overflow-hidden bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
    @if ($recipe->image_url)
    ...
    <div class="p-6">
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex space-x-2">
                ...
                @endif
                <button wire:click="openEditModal({{ $recipe->recipe_id }})"
                    class="p-2 text-gray-600 transition rounded-lg hover:bg-gray-100">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                </button>
                <button wire:click="openDeleteModal({{ $recipe->recipe_id }})"
                    class="p-2 text-red-600 transition rounded-lg hover:bg-red-50">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
